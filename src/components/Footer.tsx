        ...
        <div className="grid md:grid-cols-5 gap-12 mb-12">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            {[
              ...
              <a key={s.label} href={s.url} target="_blank" rel="noopener noreferrer" aria-label={`Follow ${site.name} on ${s.label}`} className="w-12 h-12 rounded-lg bg-primary-foreground/10 flex items-center justify-center hover:bg-primary-foreground/20 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/partners" className="text-primary-foreground/70 hover:text-primary-foreground transition-colors">For Businesses</Link>
              </li>
              <li>
