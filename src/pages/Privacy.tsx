            ...
            <div className="space-y-8 text-foreground">
              ...
              <section className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  At Meal Saver, we are committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your data when you use our website and WhatsApp channels.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  Meal Saver is a communication and promotion service. We share surplus food deal information from restaurants — we do not sell food, deliver food, or process payments.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <h3 className="text-xl font-semibold text-foreground mt-4">Information You Provide</h3>
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  <li>Name and contact details (phone number, email address) when you submit a partner application or contact form</li>
                  <li>Restaurant details (name, address, FSSAI status) for partner onboarding</li>
              ...
              <section className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  <li>Process partner applications and contact form submissions</li>
                  <li>Communicate with restaurant partners about surplus food deals</li>
                  <li>Publish verified deal information in WhatsApp channels</li>
              ...
              <section className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  <li><strong className="text-foreground">Service Providers:</strong> Third parties who help operate our website and backend infrastructure</li>
                  <li><strong className="text-foreground">Legal Authorities:</strong> When required by law or to protect our rights</li>
                </ul>
                <p className="text-muted-foreground leading-relaxed">
                  We do not sell your personal information to third parties for marketing purposes. Since Meal Saver does not process payments or manage orders, we do not share payment or transaction data.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  ...
                  <li>Rate limiting and abuse prevention on form submissions</li>
              ...
              <section className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  We retain your personal information for as long as necessary to provide our services and fulfill the purposes described in this policy. We may retain certain data longer for legal, accounting, or abuse prevention purposes.
                </p>
              </section>
              ...
              <section className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  We may update this Privacy Policy from time to time. We will notify you of significant changes by posting a notice on our website. Your continued use after changes constitutes acceptance of the updated policy.
                </p>
              </section>
